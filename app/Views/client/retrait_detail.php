        ...
        <div class="card shadow-sm">
            <div class="card-body p-4">
                <div class="d-flex justify-content-between align-items-start mb-4">
                    <div>
                        <h1 class="h3 mb-1">Détail du retrait</h1>
                ...
                <dl class="row mb-0">
                    ...
                    <dd class="col-sm-7"><?= esc($operation['numero_telephone']) ?></dd>

                    <dt class="col-sm-5">Date</dt>
                    <dd class="col-sm-7"><?= esc($operation['created_at']) ?></dd>

                    <dt class="col-sm-5">Montant retiré</dt>
                    ...
                    <dt class="col-sm-5">Solde après retrait</dt>
                    <dd class="col-sm-7 fw-semibold"><?= number_format((int) $operation['solde_source_apres'], 0, ',', ' ') ?> Ar</dd>
                </dl>
            </div>
            <div class="card-footer d-flex gap-2">
                <a class="btn btn-primary" href="/client/retrait">Nouveau retrait</a>
